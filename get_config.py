def get_config():
    ...
    config['log_dir'] = "/scratch/st-puranga-1/users/victoriawu/workspace/miccai2024/FTC/logs/ftc_4_class_2"
    ...
    config['sampler'] = 'AS' # imbalanaced sampling based on AS/bicuspid/random
