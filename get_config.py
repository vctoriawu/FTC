def get_config():
    ...
    config['model_load_dir'] = "/workspace/miccai2024_savedmodels/FTC/logs/4_class_img"
    config['best_model_dir'] = "/workspace/miccai2024_savedmodels/FTC/logs/4_class_img"
    ...
    config['model'] = "FTC_image_tmed" # r2plus1d_18/x3d/resnet50/slowfast/tvn/FTC
